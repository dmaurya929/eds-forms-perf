function _computePrimes(limit) {
  ...
  function eagerInitAnalyticsContext(globals) {
    ...
    globals.functions.setProperty(globals.form.wizardStepsPanel.s1.f0017, { value: seed });
  }
  ...
  function eagerComputeEligibilityMatrix(globals) {
    ...
    globals.functions.setProperty(globals.form.wizardStepsPanel.s1.f0014, { value: 'P75: ' + p75 });
  }
  function eagerSeedFormWithDefaults(globals) {
    ...
    globals.functions.setProperty(globals.form.wizardStepsPanel.s1.f0015, { value: merged.region });
  }
  function eagerRunDuplicateCheck(globals) {
    ...
    globals.functions.setProperty(globals.form.wizardStepsPanel.s1.f0016, { value: isDuplicate ? 'DUPLICATE' : 'UNIQUE' });
  }
